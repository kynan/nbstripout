...
def test_diff_with_process_substitution_nodiff(pytester: pytest.Pytester):
    ...
    r = pytester.run(
        'diff',
        '<(', 'nbstripout', '-t', NOTEBOOKS_FOLDER / "test_diff.ipynb", ')',
        '<(', 'nbstripout', '-t', NOTEBOOKS_FOLDER / "test_diff_output.ipynb", ')',
    )
...
def test_diff_with_process_substitution_diff(pytester: pytest.Pytester):
    ...
    r = pytester.run(
        'diff',
        '<(', 'nbstripout', '-t', NOTEBOOKS_FOLDER / "test_diff.ipynb", ')',
        '<(', 'nbstripout', '-t', NOTEBOOKS_FOLDER / "test_diff_different.ipynb", ')',
    )
